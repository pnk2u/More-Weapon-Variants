...
public class MoreWeaponVariantItems {
    ...
    private static Item.Properties arrowProperties(Item stickIngredient, boolean tipped) {
        ...
        return properties;
            ...
            // Swords
            public static final Item ACACIA_WOODEN_SWORD = new SwordItem(WOOD, swordAD, swordAS, swordProperties("wooden", ACACIA_STICK));
            public static final Item BAMBOO_WOODEN_SWORD = new SwordItem(WOOD, swordAD, swordAS, swordProperties("wooden", Items.BAMBOO));
            public static final Item BIRCH_WOODEN_SWORD = new SwordItem(WOOD, swordAD, swordAS, swordProperties("wooden", BIRCH_STICK));
            public static final Item CHERRY_WOODEN_SWORD = new SwordItem(WOOD, swordAD, swordAS, swordProperties("wooden", CHERRY_STICK));
            public static final Item CRIMSON_WOODEN_SWORD = new SwordItem(WOOD, swordAD, swordAS, swordProperties("wooden", CRIMSON_STICK));
            public static final Item DARK_OAK_WOODEN_SWORD = new SwordItem(WOOD, swordAD, swordAS, swordProperties("wooden", DARK_OAK_STICK));
            public static final Item PALE_OAK_WOODEN_SWORD = new SwordItem(WOOD, swordAD, swordAS, swordProperties("wooden", PALE_OAK_STICK));
            public static final Item JUNGLE_WOODEN_SWORD = new SwordItem(WOOD, swordAD, swordAS, swordProperties("wooden", JUNGLE_STICK));
            public static final Item MANGROVE_WOODEN_SWORD = new SwordItem(WOOD, swordAD, swordAS, swordProperties("wooden", MANGROVE_STICK));
            public static final Item SPRUCE_WOODEN_SWORD = new SwordItem(WOOD, swordAD, swordAS, swordProperties("wooden", SPRUCE_STICK));
            public static final Item WARPED_WOODEN_SWORD = new SwordItem(WOOD, swordAD, swordAS, swordProperties("wooden", WARPED_STICK));

                    public static final Item ACACIA_STONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("stone", ACACIA_STICK));
                    public static final Item BAMBOO_STONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("stone", Items.BAMBOO));
                    public static final Item BIRCH_STONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("stone", BIRCH_STICK));
                    public static final Item CHERRY_STONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("stone", CHERRY_STICK));
                    public static final Item CRIMSON_STONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("stone", CRIMSON_STICK));
                    public static final Item DARK_OAK_STONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("stone", DARK_OAK_STICK));
                    public static final Item PALE_OAK_STONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("stone", PALE_OAK_STICK));
                    public static final Item JUNGLE_STONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("stone", JUNGLE_STICK));
                    public static final Item MANGROVE_STONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("stone", MANGROVE_STICK));
                    public static final Item SPRUCE_STONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("stone", SPRUCE_STICK));
                    public static final Item WARPED_STONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("stone", WARPED_STICK));

                    public static final Item ACACIA_DEEPSLATE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("deepslate", ACACIA_STICK));
                    public static final Item BAMBOO_DEEPSLATE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("deepslate", Items.BAMBOO));
                    public static final Item BIRCH_DEEPSLATE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("deepslate", BIRCH_STICK));
                    public static final Item CHERRY_DEEPSLATE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("deepslate", CHERRY_STICK));
                    public static final Item CRIMSON_DEEPSLATE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("deepslate", CRIMSON_STICK));
                    public static final Item DARK_OAK_DEEPSLATE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("deepslate", DARK_OAK_STICK));
                    public static final Item PALE_OAK_DEEPSLATE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("deepslate", PALE_OAK_STICK));
                    public static final Item JUNGLE_DEEPSLATE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("deepslate", JUNGLE_STICK));
                    public static final Item MANGROVE_DEEPSLATE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("deepslate", MANGROVE_STICK));
                    public static final Item OAK_DEEPSLATE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("deepslate", Items.STICK));
                    public static final Item SPRUCE_DEEPSLATE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("deepslate", SPRUCE_STICK));
                    public static final Item WARPED_DEEPSLATE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("deepslate", WARPED_STICK));

                    public static final Item ACACIA_BLACKSTONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("blackstone", ACACIA_STICK));
                    public static final Item BAMBOO_BLACKSTONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("blackstone", Items.BAMBOO));
                    public static final Item BIRCH_BLACKSTONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("blackstone", BIRCH_STICK));
                    public static final Item CHERRY_BLACKSTONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("blackstone", CHERRY_STICK));
                    public static final Item CRIMSON_BLACKSTONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("blackstone", CRIMSON_STICK));
                    public static final Item DARK_OAK_BLACKSTONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("blackstone", DARK_OAK_STICK));
                    public static final Item PALE_OAK_BLACKSTONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("blackstone", PALE_OAK_STICK));
                    public static final Item JUNGLE_BLACKSTONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("blackstone", JUNGLE_STICK));
                    public static final Item MANGROVE_BLACKSTONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("blackstone", MANGROVE_STICK));
                    public static final Item OAK_BLACKSTONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("blackstone", Items.STICK));
                    public static final Item SPRUCE_BLACKSTONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("blackstone", SPRUCE_STICK));
                    public static final Item WARPED_BLACKSTONE_SWORD = new SwordItem(STONE, swordAD, swordAS, swordProperties("blackstone", WARPED_STICK));

            public static final Item ACACIA_GOLDEN_SWORD = new SwordItem(GOLD, swordAD, swordAS, swordProperties("golden", ACACIA_STICK));
            public static final Item BAMBOO_GOLDEN_SWORD = new SwordItem(GOLD, swordAD, swordAS, swordProperties("golden", Items.BAMBOO));
            public static final Item BIRCH_GOLDEN_SWORD = new SwordItem(GOLD, swordAD, swordAS, swordProperties("golden", BIRCH_STICK));
            public static final Item CHERRY_GOLDEN_SWORD = new SwordItem(GOLD, swordAD, swordAS, swordProperties("golden", CHERRY_STICK));
            public static final Item CRIMSON_GOLDEN_SWORD = new SwordItem(GOLD, swordAD, swordAS, swordProperties("golden", CRIMSON_STICK));
            public static final Item DARK_OAK_GOLDEN_SWORD = new SwordItem(GOLD, swordAD, swordAS, swordProperties("golden", DARK_OAK_STICK));
            public static final Item PALE_OAK_GOLDEN_SWORD = new SwordItem(GOLD, swordAD, swordAS, swordProperties("golden", PALE_OAK_STICK));
            public static final Item JUNGLE_GOLDEN_SWORD = new SwordItem(GOLD, swordAD, swordAS, swordProperties("golden", JUNGLE_STICK));
            public static final Item MANGROVE_GOLDEN_SWORD = new SwordItem(GOLD, swordAD, swordAS, swordProperties("golden", MANGROVE_STICK));
            public static final Item SPRUCE_GOLDEN_SWORD = new SwordItem(GOLD, swordAD, swordAS, swordProperties("golden", SPRUCE_STICK));
            public static final Item WARPED_GOLDEN_SWORD = new SwordItem(GOLD, swordAD, swordAS, swordProperties("golden", WARPED_STICK));

            public static final Item ACACIA_IRON_SWORD = new SwordItem(IRON, swordAD, swordAS, swordProperties("iron", ACACIA_STICK));
            public static final Item BAMBOO_IRON_SWORD = new SwordItem(IRON, swordAD, swordAS, swordProperties("iron", Items.BAMBOO));
            public static final Item BIRCH_IRON_SWORD = new SwordItem(IRON, swordAD, swordAS, swordProperties("iron", BIRCH_STICK));
            public static final Item CHERRY_IRON_SWORD = new SwordItem(IRON, swordAD, swordAS, swordProperties("iron", CHERRY_STICK));
            public static final Item CRIMSON_IRON_SWORD = new SwordItem(IRON, swordAD, swordAS, swordProperties("iron", CRIMSON_STICK));
            public static final Item DARK_OAK_IRON_SWORD = new SwordItem(IRON, swordAD, swordAS, swordProperties("iron", DARK_OAK_STICK));
            public static final Item PALE_OAK_IRON_SWORD = new SwordItem(IRON, swordAD, swordAS, swordProperties("iron", PALE_OAK_STICK));
            public static final Item JUNGLE_IRON_SWORD = new SwordItem(IRON, swordAD, swordAS, swordProperties("iron", JUNGLE_STICK));
            public static final Item MANGROVE_IRON_SWORD = new SwordItem(IRON, swordAD, swordAS, swordProperties("iron", MANGROVE_STICK));
            public static final Item SPRUCE_IRON_SWORD = new SwordItem(IRON, swordAD, swordAS, swordProperties("iron", SPRUCE_STICK));
            public static final Item WARPED_IRON_SWORD = new SwordItem(IRON, swordAD, swordAS, swordProperties("iron", WARPED_STICK));

            public static final Item ACACIA_DIAMOND_SWORD = new SwordItem(DIAMOND, swordAD, swordAS, swordProperties("diamond", ACACIA_STICK));
            public static final Item BAMBOO_DIAMOND_SWORD = new SwordItem(DIAMOND, swordAD, swordAS, swordProperties("diamond", Items.BAMBOO));
            public static final Item BIRCH_DIAMOND_SWORD = new SwordItem(DIAMOND, swordAD, swordAS, swordProperties("diamond", BIRCH_STICK));
            public static final Item CHERRY_DIAMOND_SWORD = new SwordItem(DIAMOND, swordAD, swordAS, swordProperties("diamond", CHERRY_STICK));
            public static final Item CRIMSON_DIAMOND_SWORD = new SwordItem(DIAMOND, swordAD, swordAS, swordProperties("diamond", CRIMSON_STICK));
            public static final Item DARK_OAK_DIAMOND_SWORD = new SwordItem(DIAMOND, swordAD, swordAS, swordProperties("diamond", DARK_OAK_STICK));
            public static final Item PALE_OAK_DIAMOND_SWORD = new SwordItem(DIAMOND, swordAD, swordAS, swordProperties("diamond", PALE_OAK_STICK));
            public static final Item JUNGLE_DIAMOND_SWORD = new SwordItem(DIAMOND, swordAD, swordAS, swordProperties("diamond", JUNGLE_STICK));
            public static final Item MANGROVE_DIAMOND_SWORD = new SwordItem(DIAMOND, swordAD, swordAS, swordProperties("diamond", MANGROVE_STICK));
            public static final Item SPRUCE_DIAMOND_SWORD = new SwordItem(DIAMOND, swordAD, swordAS, swordProperties("diamond", SPRUCE_STICK));
            public static final Item WARPED_DIAMOND_SWORD = new SwordItem(DIAMOND, swordAD, swordAS, swordProperties("diamond", WARPED_STICK));

            public static final Item ACACIA_NETHERITE_SWORD = new SwordItem(NETHERITE, swordAD, swordAS, swordProperties("netherite", ACACIA_STICK));
            public static final Item BAMBOO_NETHERITE_SWORD = new SwordItem(NETHERITE, swordAD, swordAS, swordProperties("netherite", Items.BAMBOO));
            public static final Item BIRCH_NETHERITE_SWORD = new SwordItem(NETHERITE, swordAD, swordAS, swordProperties("netherite", BIRCH_STICK));
            public static final Item CHERRY_NETHERITE_SWORD = new SwordItem(NETHERITE, swordAD, swordAS, swordProperties("netherite", CHERRY_STICK));
            public static final Item CRIMSON_NETHERITE_SWORD = new SwordItem(NETHERITE, swordAD, swordAS, swordProperties("netherite", CRIMSON_STICK));
            public static final Item DARK_OAK_NETHERITE_SWORD = new SwordItem(NETHERITE, swordAD, swordAS, swordProperties("netherite", DARK_OAK_STICK));
            public static final Item PALE_OAK_NETHERITE_SWORD = new SwordItem(NETHERITE, swordAD, swordAS, swordProperties("netherite", PALE_OAK_STICK));
            public static final Item JUNGLE_NETHERITE_SWORD = new SwordItem(NETHERITE, swordAD, swordAS, swordProperties("netherite", JUNGLE_STICK));
            public static final Item MANGROVE_NETHERITE_SWORD = new SwordItem(NETHERITE, swordAD, swordAS, swordProperties("netherite", MANGROVE_STICK));
            public static final Item SPRUCE_NETHERITE_SWORD = new SwordItem(NETHERITE, swordAD, swordAS, swordProperties("netherite", SPRUCE_STICK));
            public static final Item WARPED_NETHERITE_SWORD = new SwordItem(NETHERITE, swordAD, swordAS, swordProperties("netherite", WARPED_STICK));
